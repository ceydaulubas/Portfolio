...
import WeatherForeCast from "../images/WebProjectScreen/weather-api-mainscreen.jpg"
  ...
  return (
    <BoxP>
      <div className="containerP">
        ...
        {/* PROJECT 3 */}
        <Card className="projectL" style={{ borderRadius: "25px" }}>
          <Card.Img variant="top" src={WeatherForeCast} className="projectImage" />
          <Card.Body>
            <Card.Title >Weather Forecast</Card.Title>
            <Card.Text >
            Weather forecast website gives information about weather like current weather, coming days weather, min-max temperatures, etc.
        </Card.Text>
            <Card.Text style={{ marginBottom: '1%' }}>
          ...
          <Card.Footer>
            <a
              className="btn-primary pt-1 pb-1 pl-2 pr-2"
              href="https://github.com/ceydaulubas/reactjs-weather-api"
              target="_blank"
              rel=" noopener noreferrer"
            >
              Github
